...
export function PostCard({
  ...
  return (
    <article
      ...
      className={cn(
        "rounded-card border border-border border-l-2 bg-canvas-raised p-4 shadow-card",
    ...
    >
      <header className="flex items-start gap-3">
        ...
        <span className="rounded-pill border border-border px-2 py-0.5 text-xs text-ink-muted">
      ...
      <div className="mt-4 flex items-center gap-5 border-t border-border pt-3 text-ink-muted">
        <button
          ...
          className={cn(
            "flex items-center gap-1.5 text-xs transition-colors hover:text-role-tutor",
            likedByMe && "text-role-tutor",
          )}
        >
        ...
        <button
          ...
          className={cn(
            "ml-auto flex items-center gap-1.5 text-xs transition-colors hover:text-accent",
            bookmarkedByMe && "text-accent",
          )}
        >
          <Bookmark size={16} fill={bookmarkedByMe ? "currentColor" : "none"} />
        </button>
